...
function _getActualSectionTitles(markdown: string) {
...
- Went somewhere.`}
  ...
  it('renders section navigation and self-links for the real about markdown', () => {
    ...
    const sectionTitles = ['I Like', 'Travel'];
  ...
  it('supports same-page hash navigation from section links', async () => {
    ...
    const markdown = `# Intro\n\nLead.\n\n# I Like\n\n- Running\n\n# Travel\n\n- Places`;
    render(<AboutContent markdown={markdown} />);
    ...
    const heading = screen.getByRole('heading', { name: 'I Like' });
